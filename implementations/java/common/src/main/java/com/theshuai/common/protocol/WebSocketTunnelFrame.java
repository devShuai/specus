...
public record WebSocketTunnelFrame(int opcode, boolean finalFragment, int rsv,
    ...
    public static WebSocketTunnelFrame decode(byte[] encoded) {
        ...
        buffer.get(payload);
        return new WebSocketTunnelFrame(opcode, finalFragment, rsv, closeCode, payload);
    }
