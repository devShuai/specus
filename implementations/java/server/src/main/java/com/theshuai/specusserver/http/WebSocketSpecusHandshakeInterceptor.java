 ...
 * 供 {@link WebSocketSpecusHandler#afterConnectionEstablished} 组装 {@code CONNECTED} 帧使用。
 *
 * <p>握手阶段还会做最小校验：
 * <ul>
...
@Component
@Slf4j
public class WebSocketSpecusHandshakeInterceptor implements HandshakeInterceptor {
    ...
    public boolean beforeHandshake(ServerHttpRequest request,
        ...
        if (!(request instanceof ServletServerHttpRequest servletRequest)) {
            log.warn("[ws-specus][handshake] non-servlet request, rejecting");
            return false;
        }
