 ...
 * {@code client.jsonc:httpSpecusConfigList} 中的一项，但服务端为权威来源：
 ...
 *
 * <p>客户端 ID 使用 {@code Long}（无外键约束，与 {@link SpecusMapping} 的处理一致）—— 删除
...
public class HttpRouteMapping {
    ...
    /** 冗余字段，与 {@link SpecusMapping#getClientName()} 同样的考虑：列表展示无需 join。 */
    ...
    /**
     * 是否开启响应体路径改写。开启后，{@code HttpSpecusController} 在把上游响应回写浏览器之前，
