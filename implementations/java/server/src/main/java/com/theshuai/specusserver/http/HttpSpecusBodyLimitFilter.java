...
public class HttpSpecusBodyLimitFilter extends OncePerRequestFilter {
    ...
    public HttpSpecusBodyLimitFilter(
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (isHttpSpecusRequest(request) && request.getContentLengthLong() > maxRequestBodySize) {
    ...
    private boolean isHttpSpecusRequest(HttpServletRequest request) {
