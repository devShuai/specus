...
public class ElasticsearchConnectionDetailsConfig {
    ...
    public ElasticsearchConnectionDetails specusElasticsearchConnectionDetails(ElasticsearchProperties properties) {
        return new SpecusElasticsearchConnectionDetails(properties);
    }

    private static class SpecusElasticsearchConnectionDetails implements ElasticsearchConnectionDetails {
        private final ElasticsearchProperties properties;

        private SpecusElasticsearchConnectionDetails(ElasticsearchProperties properties) {
