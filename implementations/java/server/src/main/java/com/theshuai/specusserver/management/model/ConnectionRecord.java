...
@Entity
@Table(name = "specus_connection_record", indexes = {
        @Index(name = "idx_specus_connection_tenant", columnList = "tenant_id"),
        ...
        @Index(name = "idx_specus_connection_client_time", columnList = "client_id, connected_at"),
        // Serves the retention purge (connected_at < cutoff).
        @Index(name = "idx_specus_connection_connected_at", columnList = "connected_at"),
        @Index(name = "idx_specus_connection_tenant_id", columnList = "tenant_id, id"),
        @Index(name = "idx_specus_connection_tenant_client_id", columnList = "tenant_id, client_id, id"),
        @Index(name = "idx_specus_connection_tenant_success", columnList = "tenant_id, success"),
        @Index(name = "idx_specus_connection_tenant_client_time", columnList = "tenant_id, client_id, connected_at")
})
@Getter
@Setter
