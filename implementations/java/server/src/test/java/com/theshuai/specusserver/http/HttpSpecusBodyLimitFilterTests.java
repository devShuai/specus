...
class HttpSpecusBodyLimitFilterTests {

    private final TrafficInspectionService trafficInspectionService = mock(TrafficInspectionService.class);
    private final HttpSpecusBodyLimitFilter filter = new HttpSpecusBodyLimitFilter(10, trafficInspectionService);
    ...
    @Test
    void ignoresNonHttpSpecusRequests() throws Exception {
