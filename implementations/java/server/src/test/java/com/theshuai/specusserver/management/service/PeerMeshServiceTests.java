...
class PeerMeshServiceTests {
    ...
    void relayTrafficFlushRestoresBatchAfterRepositoryFailure() {
        ...
        assertThat(meterRegistry.get("specus.peer_mesh.relay.traffic.flush.failures").counter().count())
                .isEqualTo(1);
        assertThat(meterRegistry.get("specus.peer_mesh.relay.traffic.pending.bytes").gauge().value())
                .isEqualTo(512);
