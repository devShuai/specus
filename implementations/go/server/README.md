...
| `TUNNEL_OBJECT_STORAGE_PER_USER_STORAGE_QUOTA_BYTES` / `TUNNEL_OBJECT_STORAGE_PER_USER_MONTHLY_DOWNLOAD_QUOTA_BYTES` | 每个登录账号的有效存储 / UTC 月下载签名流量额度 | 1073741824 / 1073741824 |
