...
#define ST_MESSAGE_TYPE_SERVER_TO_CLIENT 0
#define ST_MESSAGE_TYPE_CLIENT_TO_SERVER 1
#define ST_MESSAGE_TYPE_CLIENT_TO_CLIENT 2
#define ST_MESSAGE_TYPE_NAT_CONTROL 3
#define ST_MESSAGE_TYPE_PEER_CONTROL 4
