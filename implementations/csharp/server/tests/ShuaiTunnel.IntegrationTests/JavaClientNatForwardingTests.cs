...
/// <item>The real Java tunnel-client jar pointed at the C# server + the echo upstream.</item>
/// </list>
///
...
public sealed class JavaClientNatForwardingTests : IAsyncLifetime
{
    ...
    public async Task ExternalClient_RoundTripsThroughJavaClientAndUpstreamEcho()
    {
        ...
        // the tunnel. We can probe the per-port active-connection count via RemotePortServerManager
