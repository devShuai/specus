...
/// <summary>
/// Tiny TCP echo server used as the upstream target for the Java specus-client's
/// <c>specusConfigList</c>. Each accepted socket gets its own read loop that copies every
