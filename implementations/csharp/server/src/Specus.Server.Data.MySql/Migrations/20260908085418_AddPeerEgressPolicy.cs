        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    egress_client_name = table.Column<string>(type: "varchar(120)", maxLength: 120, nullable: false),
                    enabled = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    scope = table.Column<string>(type: "varchar(16)", maxLength: 16, nullable: false),
                    allowed_consumer_client_ids = table.Column<string>(type: "varchar(512)", maxLength: 512, nullable: false),
                    destination_rules = table.Column<string>(type: "varchar(4096)", maxLength: 4096, nullable: false),
                    max_concurrent_flows = table.Column<int>(type: "int", nullable: false),
                    max_flows_per_consumer = table.Column<int>(type: "int", nullable: false),
                    idle_timeout_seconds = table.Column<int>(type: "int", nullable: false),
