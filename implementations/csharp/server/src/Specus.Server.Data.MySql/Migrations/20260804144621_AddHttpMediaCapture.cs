        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    source_url = table.Column<string>(type: "varchar(3072)", maxLength: 3072, nullable: false),
                    resource_key = table.Column<string>(type: "varchar(64)", maxLength: 64, nullable: false),
                    deduplication_key = table.Column<string>(type: "varchar(64)", maxLength: 64, nullable: true),
                    ...
                    content_type = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: true),
                    content_encoding = table.Column<string>(type: "varchar(128)", maxLength: 128, nullable: true),
                    media_kind = table.Column<string>(type: "varchar(32)", maxLength: 32, nullable: false),
                    entity_tag = table.Column<string>(type: "varchar(512)", maxLength: 512, nullable: true),
                    last_modified = table.Column<string>(type: "varchar(128)", maxLength: 128, nullable: true),
                    ...
                    initialization_segment = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    live_stream = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    object_key = table.Column<string>(type: "varchar(1024)", maxLength: 1024, nullable: false),
                    upload_id = table.Column<string>(type: "varchar(1024)", maxLength: 1024, nullable: true),
                    object_etag = table.Column<string>(type: "varchar(512)", maxLength: 512, nullable: true),
                    state = table.Column<string>(type: "varchar(24)", maxLength: 24, nullable: false),
                    failure_reason = table.Column<string>(type: "varchar(2048)", maxLength: 2048, nullable: true),
                    response_headers = table.Column<string>(type: "longtext", nullable: true),
                    captured_at = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: false),
                    completed_at = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    relation_type = table.Column<string>(type: "varchar(24)", maxLength: 24, nullable: false),
                    sequence_index = table.Column<long>(type: "bigint", nullable: true),
                    original_uri = table.Column<string>(type: "varchar(2048)", maxLength: 2048, nullable: false),
                    resolved_source_url = table.Column<string>(type: "varchar(3072)", maxLength: 3072, nullable: false),
