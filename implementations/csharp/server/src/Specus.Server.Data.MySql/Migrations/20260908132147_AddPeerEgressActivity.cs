        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    rejected_flows = table.Column<string>(type: "varchar(1024)", maxLength: 1024, nullable: false),
                    bytes_in = table.Column<long>(type: "bigint", nullable: false),
                    bytes_out = table.Column<long>(type: "bigint", nullable: false),
                    reported_at = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: false),
