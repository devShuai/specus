    ...
    public partial class AddManagementRegistration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    registration_id = table.Column<string>(type: "varchar(64)", maxLength: 64, nullable: false),
                    ...
                    attempts_remaining = table.Column<int>(type: "int", nullable: false),
                    expires_at = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: false),
                    resend_available_at = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    username = table.Column<string>(type: "varchar(80)", maxLength: 80, nullable: false),
                    email = table.Column<string>(type: "varchar(254)", maxLength: 254, nullable: false),
                    verified_at = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: false),
                    created_at = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: false),
                    updated_at = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: false)
                },
                constraints: table =>
