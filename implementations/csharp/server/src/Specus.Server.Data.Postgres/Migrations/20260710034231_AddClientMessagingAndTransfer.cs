        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    room_token_hash = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                    ...
                    upload_expires_at = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    expires_at = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    uploaded_at = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true)
                },
                constraints: table =>
                {
