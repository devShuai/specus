    ...
    public partial class AddManagementAndTrafficDetailSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "specus_http_traffic_exchange",
                columns: table => new
                {
                    ...
                    resource_name = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
                    ...
                    raw_query = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: true),
                    ...
                    request_bytes = table.Column<long>(type: "INTEGER", nullable: false),
                    response_bytes = table.Column<long>(type: "INTEGER", nullable: false),
                    elapsed_ms = table.Column<long>(type: "INTEGER", nullable: false),
                    request_content_type = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
                    response_content_type = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
                    response_body_type = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    request_headers = table.Column<string>(type: "TEXT", maxLength: 8192, nullable: true),
                    response_headers = table.Column<string>(type: "TEXT", maxLength: 8192, nullable: true),
                    request_preview_hex = table.Column<string>(type: "TEXT", maxLength: 4096, nullable: true),
                    request_preview_text = table.Column<string>(type: "TEXT", nullable: true),
                    response_preview_hex = table.Column<string>(type: "TEXT", maxLength: 4096, nullable: true),
                    response_preview_text = table.Column<string>(type: "TEXT", nullable: true),
                    request_truncated = table.Column<bool>(type: "INTEGER", nullable: false),
                    response_truncated = table.Column<bool>(type: "INTEGER", nullable: false),
                    captured_at = table.Column<string>(type: "TEXT", maxLength: 40, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_specus_http_traffic_exchange", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "specus_management_user",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_specus_management_user", x => x.username);
                });

            migrationBuilder.CreateTable(
                name: "specus_resource_traffic_usage",
                columns: table => new
                {
                    Id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ...
                    resource_id = table.Column<long>(type: "INTEGER", nullable: true),
                    resource_name = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_specus_resource_traffic_usage", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "specus_tcp_traffic_frame",
                columns: table => new
                {
                    Id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ...
                    resource_id = table.Column<long>(type: "INTEGER", nullable: true),
                    resource_name = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
                    channel_id = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
                    frame_direction = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    remote_address = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
                    source_address = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
                    source_port = table.Column<int>(type: "INTEGER", nullable: true),
                    destination_address = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
                    destination_port = table.Column<int>(type: "INTEGER", nullable: true),
                    stream_offset = table.Column<long>(type: "INTEGER", nullable: false),
                    stream_end_offset = table.Column<long>(type: "INTEGER", nullable: false),
                    frame_index = table.Column<long>(type: "INTEGER", nullable: false),
                    payload_bytes = table.Column<long>(type: "INTEGER", nullable: false),
                    payload_data = table.Column<byte[]>(type: "BLOB", nullable: false),
                    payload_preview_hex = table.Column<string>(type: "TEXT", maxLength: 4096, nullable: true),
                    payload_preview_text = table.Column<string>(type: "TEXT", maxLength: 4096, nullable: true),
                    truncated = table.Column<bool>(type: "INTEGER", nullable: false),
                    frame_time = table.Column<string>(type: "TEXT", maxLength: 40, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_specus_tcp_traffic_frame", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "specus_resource_traffic_usage",
                column: "client_id");
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "specus_tcp_traffic_frame",
                column: "channel_id");
