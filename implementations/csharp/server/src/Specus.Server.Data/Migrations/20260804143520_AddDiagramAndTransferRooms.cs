        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    author_peer_id = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
                    snapshot_data = table.Column<byte[]>(type: "BLOB", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<long>(type: "INTEGER", nullable: false),
                    room_name = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
                    owner_token_hash = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    created_by_peer_id = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
                    created_at = table.Column<string>(type: "TEXT", maxLength: 40, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    created_at = table.Column<string>(type: "TEXT", maxLength: 40, nullable: false),
                    expires_at = table.Column<string>(type: "TEXT", maxLength: 40, nullable: true),
                    revoked_at = table.Column<string>(type: "TEXT", maxLength: 40, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    owner_username = table.Column<string>(type: "TEXT", maxLength: 160, nullable: false),
