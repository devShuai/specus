...
/// <summary>
/// Mirrors Java <c>specus_client_credential</c>. The stored secret is
...
/// <summary>Mirrors Java <c>specus_client_identity</c>, one row per credential + machine + OS user.</summary>
...
/// <summary>Mirrors Java <c>specus_client_session</c> for HTTP login and control-channel state.</summary>
