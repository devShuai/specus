    ...
    public partial class AddProtocolSecurityV2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    api_key_hash = table.Column<string>(type: "varchar(64)", maxLength: 64, nullable: false),
                    nonce_hash = table.Column<string>(type: "varchar(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    tenant_id = table.Column<string>(type: "varchar(80)", maxLength: 80, nullable: true),
                    is_admin = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    room_id = table.Column<string>(type: "varchar(120)", maxLength: 120, nullable: true),
                    room_key = table.Column<string>(type: "varchar(80)", maxLength: 80, nullable: true),
                    peer_id = table.Column<string>(type: "varchar(120)", maxLength: 120, nullable: true),
                    display_name = table.Column<string>(type: "varchar(120)", maxLength: 120, nullable: true),
                    shared_room = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    remote_address_hash = table.Column<string>(type: "varchar(64)", maxLength: 64, nullable: false),
                    created_at = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: false),
                    expires_at = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: false)
                },
                constraints: table =>
