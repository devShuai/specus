        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    room_token_hash = table.Column<string>(type: "varchar(64)", maxLength: 64, nullable: true),
                    owner_username = table.Column<string>(type: "varchar(80)", maxLength: 80, nullable: true),
                    target_client_id = table.Column<long>(type: "bigint", nullable: true),
                    object_key = table.Column<string>(type: "varchar(512)", maxLength: 512, nullable: false),
                    ...
                    upload_expires_at = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: false),
                    expires_at = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: false),
                    uploaded_at = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: true)
                },
                constraints: table =>
                {
