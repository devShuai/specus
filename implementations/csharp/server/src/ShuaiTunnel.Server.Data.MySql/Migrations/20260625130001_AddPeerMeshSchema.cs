...
namespace ShuaiTunnel.Server.Data.MySql.Migrations
{
    ...
    [Migration("20260625130001_AddPeerMeshSchema")]
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    owner_username = table.Column<string>(type: "varchar(80)", maxLength: 80, nullable: false),
                    source_client_id = table.Column<long>(type: "bigint", nullable: false),
                    source_client_name = table.Column<string>(type: "varchar(120)", maxLength: 120, nullable: false),
                    target_client_id = table.Column<long>(type: "bigint", nullable: false),
                    target_client_name = table.Column<string>(type: "varchar(120)", maxLength: 120, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    virtual_ip = table.Column<string>(type: "varchar(64)", maxLength: 64, nullable: false),
                    cidr = table.Column<string>(type: "varchar(64)", maxLength: 64, nullable: false),
                    public_key = table.Column<string>(type: "varchar(256)", maxLength: 256, nullable: true),
                    nat_type = table.Column<string>(type: "varchar(80)", maxLength: 80, nullable: true),
                    last_endpoint = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: true),
                    virtual_device_mode = table.Column<string>(type: "varchar(80)", maxLength: 80, nullable: true),
                    virtual_device_name = table.Column<string>(type: "varchar(80)", maxLength: 80, nullable: true),
                    virtual_device_status = table.Column<string>(type: "varchar(80)", maxLength: 80, nullable: true),
                    virtual_device_error = table.Column<string>(type: "varchar(512)", maxLength: 512, nullable: true),
                    virtual_device_updated_at = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: true),
                    enabled = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    last_seen_at = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: true),
                    created_at = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: false),
                    updated_at = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    target_client_id = table.Column<long>(type: "bigint", nullable: false),
                    target_client_name = table.Column<string>(type: "varchar(120)", maxLength: 120, nullable: false),
                    path_type = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: false),
                    status = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: false),
                    token_hash = table.Column<string>(type: "varchar(64)", maxLength: 64, nullable: true),
                    started_at = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: false),
                    updated_at = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: false),
                    ...
                    local_endpoint = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: true),
                    remote_endpoint = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: true),
                    direct_bytes = table.Column<long>(type: "bigint", nullable: false),
                    relay_bytes = table.Column<long>(type: "bigint", nullable: false),
                    last_traffic_at = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: true)
                },
                constraints: table =>
                {
