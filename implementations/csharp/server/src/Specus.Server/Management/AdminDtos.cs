...
public sealed record ClientDetailView(
    ...
    IReadOnlyList<SpecusMappingView> SpecusMappings,
...
public sealed record ClientAccountView(
    ...
    bool MessageMediaPreviewCapable,
...
public sealed record SpecusMappingView(
    long Id,
    long ClientId,
    string ClientName,
    int ListenPort,
...
public sealed record SpecusMappingMutation(
    int? ListenPort,
    string? TargetAddress,
    int? TargetPort,
    bool? Enabled,
