...
const targets = {
  go: join(repoRoot, "tunnel-server-go", "web", "static"),
  csharp: join(repoRoot, "tunnel-server-csharp", "src", "ShuaiTunnel.Server", "wwwroot"),
  java: join(repoRoot, "tunnel-server", "src", "main", "resources", "static"),
};
