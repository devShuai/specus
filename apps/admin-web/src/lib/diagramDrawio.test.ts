...
const processNode: DiagramNode = {
  ...
  locked: true,
  rotation: 90,
  style: { fillColor: "#dbeafe", strokeColor: "#2563eb", fontColor: "#172033", strokeWidth: 2, fontSize: 18, bold: false, italic: true, align: "left", opacity: 75, shadow: false, rounded: true },
};
